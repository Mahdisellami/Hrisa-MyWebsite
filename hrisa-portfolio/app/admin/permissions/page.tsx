              ...
              <tr key={resource.id} className="hover:bg-sand-50">
                ...
                <td className="px-6 py-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${
                    resource.min_role === 'ADMIN' ? 'bg-red-100 text-red-700 border-red-200' :
                    resource.min_role === 'EDITOR' ? 'bg-blue-100 text-blue-700 border-blue-200' :
                    resource.min_role === 'PUBLIC' ? 'bg-gray-100 text-gray-700 border-gray-200' :
                    resource.min_role === 'VISITOR' ? 'bg-green-100 text-green-700 border-green-200' :
